...
function ProductPage() {
  ...
  const variantsList = useMemo(() => {
    ...
    if (cat?.slug === "vases" || cat?.slug === "planters") return ["Small", "Medium", "Large", "XL"];
      ...
      <section className="container-x py-20 border-t">
            ...
            <DialogContent className="max-w-lg">
              ...
              <form onSubmit={handleReviewSubmit} className="space-y-4 mt-4">
                ...
                <div>
                  ...
                  <textarea required name="body" rows={4} placeholder="Tell us what you liked about this piece..." className="w-full border-b py-2 focus:outline-none" />
                </div>
        ...
        {reviews.length === 0 ? (
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {reviews.map((r) => (
              <Reveal key={r.id}>
                <div className="border p-6 h-full flex flex-col justify-between">
                  <div>
                  ...
                  <p className="mt-6 text-xs uppercase tracking-[0.18em] text-muted-foreground">— {r.customer_name}</p>
                </div>
              </Reveal>
            ))}
          </div>
